...
{% macro synapsespark__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro synapsespark__check_schema_exists(information_schema,schema) -%}
...
{% macro synapsespark__list_relations_without_caching(schema_relation) -%}
...
{% macro synapsespark__truncate_relation(relation) -%}
...
{% macro synapsespark__current_timestamp() -%}
